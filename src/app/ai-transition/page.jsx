            ...
            {[
              {
                ...
                description:
                  "Comprehensive evaluation of your current infrastructure, data maturity, and AI readiness. We identify gaps and opportunities specific to your organization.",
                highlights: [
                  "Data Audit",
              ...
              },
              {
                ...
                description:
                  "Strategic planning tailored to your business goals. We define phases, timelines, resource requirements, and success metrics.",
                highlights: [
                  "Priority Setting",
                  "Timeline Planning",
                  "Budget Allocation",
              ...
              },
              {
                ...
                description:
                  "Prepare your data for AI by cleaning, organizing, and migrating to cloud or on-premise AI platforms with minimal disruption.",
                highlights: [
                  "Data Cleaning",
                  "Integration",
                  "Migration",
              ...
              },
              {
                ...
                description:
                  "Implement AI models and automation workflows that deliver immediate ROI through process optimization and intelligence.",
                highlights: [
                  "Model Development",
                  "Deployment",
                  "Integration",
              ...
              },
              {
                ...
                description:
                  "Train your team to work effectively with AI systems. Build new skills and create a culture of continuous learning.",
                highlights: [
                  "Training Programs",
                  "Documentation",
                  "Support",
              ...
              <div
                key={idx}
                className="relative p-8 rounded-3xl bg-white/80 backdrop-blur-xl border border-white/50 hover:shadow-xl transition-all"
              >
