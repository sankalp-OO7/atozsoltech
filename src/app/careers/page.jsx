...
export default function Page() {
  return (
    <SectionWrapper>
      ...
      >
        <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-slate-900 via-indigo-600 to-slate-900 bg-clip-text text-transparent">
          Careers
        </h1>
      ...
      <motion.div
        ...
        className="bg-indigo-50 rounded-3xl p-12 mb-20 border border-indigo-200"
      >
